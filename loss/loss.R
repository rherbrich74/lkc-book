...
book <- function (output='SCREEN') {
  ...
  if (output == 'PS') {
    postscript (file="clipped_loss.ps");
  }
  ...
  if (output == 'PS') {
    postscript (file="loss_sigmoid.ps");
  }
