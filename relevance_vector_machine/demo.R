...
book <- function () {
  ...
  if (!file.exists ("../../ps/rvm_marginalised_prior.ps")) {
    ...
    postscript ("../../ps/rvm_marginalised_prior.ps");
    ...
    legend (0.5, ylim [2] - 0.1, c ("a=1e-2, b=1e2",
            ...
            cex=2.0);
    cat ("../../ps/rvm_marginalised_prior.ps created\n");
    dev.off ();
  }

  ############################################################
  ## generate "marginalised" 2D priors
  if (!file.exists ("../../ps/rvm_marginalised_prior2.ps")) {
    ...
    postscript ("../../ps/rvm_marginalised_prior2.ps");
    ...
    cat ("../../ps/rvm_marginalised_prior2.ps created\n");
    dev.off ();
  }
